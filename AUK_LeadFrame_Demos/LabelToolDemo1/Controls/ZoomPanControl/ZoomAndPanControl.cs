...
//namespace DeepObjectDector.sub.control.ZoomPanCon
namespace CanvasDraw.Control.ZoomPanControl
{
        ...
        private void UpdateTranslationX()
        {
            if (this.contentOffsetTransform != null)
            {
                ...
                if (scaledContentWidth < this.ViewportWidth)
                {
                    ...
                    //
                    this.contentOffsetTransform.X = (this.ContentViewportWidth - this.unScaledExtent.Width) / 2;//증가분 만큼의 센터 로이동
                }
                else //아니면 
                {
