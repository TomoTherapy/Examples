...
{
    public partial class Callback_LineTrigger_Mono : Form
    {
        ...
        public Callback_LineTrigger_Mono()
        {
            InitializeComponent();
        }

        private void Callback_LineTrigger_Mono_Load(object sender, EventArgs e)
        {
        ...
        private void Callback_LineTrigger_Mono_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (_isOpen == true)
            {
                _gch.Free();
