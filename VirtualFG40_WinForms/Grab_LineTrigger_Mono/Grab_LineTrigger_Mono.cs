...
namespace Grab_LineTrigger_Mono
{
    public partial class Grab_LineTrigger_Mono : Form
    {
        ...
        public Grab_LineTrigger_Mono()
        {
            InitializeComponent();
        }

        private void Grab_LineTrigger_Mono8_Load(object sender, EventArgs e)
        {
        ...
        private void Grab_LineTrigger_Mono8_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (_isOpen == true)
            {
