...
{
    public partial class Callback_SoftwareTrigger_Mono : Form
    {
        ...
        public Callback_SoftwareTrigger_Mono()
        {
            InitializeComponent();
        }

        private void Callback_SoftwareTrigger_Mono_Load(object sender, EventArgs e)
        {
        ...
        private void Callback_SoftwareTrigger_Mono_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (_isOpen == true)
            {
                if (timer_Trigger.Enabled == true)
                {
        ...
        private void btn_Grab_Click(object sender, EventArgs e)
        {
            ...
            // 2. Excute SoftwareTrigger command
            // 3. Waiting Grab Finish
