...
{
    public partial class Callback_SoftwareTrigger_Color : Form
    {
        ...
        public Callback_SoftwareTrigger_Color()
        {
            InitializeComponent();
        }

        private void Callback_SoftwareTrigger_Color_Load(object sender, EventArgs e)
        {
        ...
        private void Callback_SoftwareTrigger_Color_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (_isOpen == true)
            {
