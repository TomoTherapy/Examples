...
{
    public partial class Grab_LineTrigger_Color : Form
    {
        ...
        public Grab_LineTrigger_Color()
        {
            InitializeComponent();
        }

        private void Grab_LineTrigger_Color8_Load(object sender, EventArgs e)
        {
        ...
        private void Grab_LineTrigger_Color8_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (_isOpen == true)
            {
        ...
        {            
            ...
            // 3. Grab Image using GrabImageAsync
            // 4. Image Display	
            // 5. Excute Acquisition Stop command
