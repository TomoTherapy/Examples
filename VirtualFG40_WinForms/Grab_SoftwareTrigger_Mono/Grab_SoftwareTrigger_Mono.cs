...
{
    public partial class Grab_SoftwareTrigger_Mono : Form
    {
        ...
        public Grab_SoftwareTrigger_Mono()
        {
            InitializeComponent();
        }

        private void Grab_SoftwareTrigger_Mono8_Load(object sender, EventArgs e)
        {
        ...
        private void Grab_SoftwareTrigger_Mono8_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (_isOpen == true)
            {
